...
// Handler A Logger prints its log records by writing to a Handler.
...
// MultiHandler A MultiHandler dispatches any write to each of its handlers.
...
func DefaultStreamHandler(wr io.Writer) Handler {
	...
	return LazyHandler(SyncHandler(DefaultCallerFuncHandler(h)))
}
